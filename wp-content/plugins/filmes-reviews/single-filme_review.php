...
// Template Default de filmes reviews

get_header(); //Traz o header do WP
...
<div id="primary" class="content-area">
    <main id="main" class="content site-main" role="main">
        ...
        while(have_posts()): the_post();
            ...
            $campo_prefixo  = FIELD_PREFIX;
            $imagem         = get_the_post_thumbnail(get_the_ID(), 'medium');//Pega a thumbnail, no tamanho médio.
            ...
            $exibir_rating  =  mostrar_rating($rating); //Função própria. Para mostrar dashicons 
